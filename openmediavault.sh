...
DISTS=synchrony,synchrony-proposed,sandworm,sandworm-proposed,shaitan-proposed,shaitan,usul-proposed,usul
EXTRA_DISTS=synchrony,sandworm,shaitan-beta,shaitan-testing,shaitan,usul-beta,usul-extras,usul-testing,usul
